...
CREATE  TABLE IF NOT EXISTS `forgetless`.`list_link` (
  ...
  INDEX `fk_list_link_category1` (`category_id` ASC) ,
  ...
  CONSTRAINT `fk_list_link_list1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_list_link_category1`
    FOREIGN KEY (`category_id` )
    REFERENCES `forgetless`.`category` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `forgetless`.`category_link` (
  ...
  PRIMARY KEY (`id`) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  INDEX `fk_category_link_user1` (`user_id` ASC) ,
  INDEX `fk_category_link_category1` (`category_id` ASC) ,
  CONSTRAINT `fk_category_link_user1`
    FOREIGN KEY (`user_id` )
    REFERENCES `forgetless`.`user` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_category_link_category1`
    FOREIGN KEY (`category_id` )
    REFERENCES `forgetless`.`category` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
